...
<body>
    <div class="page-header">
        ...
        <p class="page-subtitle">Add a new tenant to your property portfolio</p>
    </div>
    ...
    <div class="form-container">
        ...
        <form id="tenantForm" method="POST" action="/tenants/save" enctype="multipart/form-data">
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <input type="file" name="my_img" class="form-input" required>
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <div class="form-group full-width">
                    ...
                    <textarea id="property" name="property" class="form-textarea" required placeholder="Enter full property address including unit number"></textarea>
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="number" id="rent" name="rent" class="form-input" required min="0" step="0.01" placeholder="0.00">
                    </div>
                    <div class="form-group">
                ...
                <div class="form-group full-width">
                    ...
                    <div class="date-group">
                        <div class="form-group">
                            <input type="date" id="leaseStart" name="leaseStart" class="form-input" required>
                        </div>
                        <div class="date-separator">to</div>
                        <div class="form-group">
                            <input type="date" id="leaseEnd" name="leaseEnd" class="form-input" required>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <div class="form-group full-width">
                    ...
                    <textarea id="notes" name="notes" class="form-textarea" placeholder="Any additional notes about the tenant..."></textarea>
                </div>
            </div>
